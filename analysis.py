...
# Setting the x-label
plt.legend(title="Species",loc='upper right', labels=['Iris setosa', "Iris versicolor", 'Iris virginica'])
# Setting the legend
sns.despine()
...
sns.histplot(data=iris_data, x="petal_width", hue="species", palette="viridis", element="step", multiple="dodge", shrink=.8, legend=False)
...
sns.histplot(data=iris_data, x="sepal_length", hue="species", palette="viridis", element="step", multiple="dodge", shrink=.8, legend=False)
...
sns.histplot(data=iris_data, x="sepal_width", hue="species", palette="viridis", element="step", multiple="dodge", shrink=.8, legend=False)
...
sns.scatterplot(data=iris_data, x="sepal_length", y="sepal_width", hue="species", style="species", legend=True)
...
sns.scatterplot(data=iris_data, x="petal_length", y="petal_width", hue="species", style="species", legend=True)
plt.xlabel("Petal Length (cm)")
